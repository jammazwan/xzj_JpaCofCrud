...
Functionality: **_to provide failing test case for soliciting help with transactions_**
...
Git clone the xzj_JpaCofCrud project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xzj_JpaCofCrud.git
cd xzj_JpaCofCrud
mvn install -DskipTests

```

You man now import xzj_JpaCofCrud into your IDE.
